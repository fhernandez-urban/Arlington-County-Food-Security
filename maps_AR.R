...
acs = get_acs(state = "51", county = "013", geography = "tract", 
              variables = c("B03002_001", "B03002_002", "B03002_003", "B03002_004", "B03002_006", 
                            ...
                            "B01001_023", "B01001_024", "B01001_025", "B01001_027", "B01001_028", 
                            "B01001_029", "B01001_030", "B01001_042", "B01001_043", "B01001_044", 
                            "B01001_045", "B01001_046", "B01001_047", "B01001_048", "B01001_049",
                            "B17001_004", "B17001_005", "B17001_006", "B17001_007", "B17001_008", 
                            "B17001_009", "B17001_014", "B17001_015", "B17001_016", "B17001_018", 
                            "B17001_019", "B17001_020", "B17001_021", "B17001_022", "B17001_023", 
                            "B17001_028", "B17001_029", "B17001_030", 
...
wide_acs <- acs %>% dplyr::select(-moe) %>% 
  ...
  rename(total_pop = B03002_001,
         ...
         povchild2 = B17001_005,
         povchild3 = B17001_006,
         povchild4 = B17001_007,
         povchild5 = B17001_008,
         povchild6 = B17001_009,
         povchild7 = B17001_018,
         povchild8 = B17001_019,
         povchild9 = B17001_020,
         povchild10 = B17001_021,
         povchild11 = B17001_022,
         povchild12 = B17001_023,
         povsenior1 = B17001_014,
         povsenior2 = B17001_015,
         povsenior3 = B17001_016,
         povsenior4 = B17001_028,
         povsenior5 = B17001_029,
         povsenior6 = B17001_030,
  ...
  mutate(pct_nlblack = nlblack / total_pop,
         ...
         pct_povchildu18 = (povchild1+povchild2+povchild3+povchild4+povchild5+povchild6+povchild7+povchild8+povchild9+povchild10+povchild11+povchild12)/(child1+child2+child3+child4+child5+child6+child7+child8),
         pct_povseniors = ((povsenior1*.4)+povsenior2+povsenior3+(povsenior4*.4)+povsenior5+povsenior6)/(senior1+senior2+senior3+senior4+senior5+senior6+senior7+senior8+senior9+senior10+senior11+senior12+senior13+senior14+senior15+senior16))
