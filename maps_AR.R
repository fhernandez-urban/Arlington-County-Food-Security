...
wide_acs <- acs %>% dplyr::select(-moe) %>% 
  ...
  mutate(pct_nlblack = nlblack / total_pop,
         ...
         pct_povchildu18 = (povchild2+povchild3+povchild4+povchild5+povchild6+povchild7+povchild11+povchild12+povchild13+povchild14+povchild15+povchild16)/(child1+child2+child3+child4+child5+child6+child7+child8),
